...
In conclusion Spotify has used a very innovative, adaptable and scalable approach that enables each of its users to have a 'radio station' tailored to their specific interests.
